...
public interface PBackendService {
    ...
    @ProtobufRPC(serviceName = "PInternalService", methodName = "export_dictionary_cache", onceTalkTimeout = 60000)
    Future<PExportDictionaryCacheResult> exportDictionaryCache(PExportDictionaryCacheRequest request);
